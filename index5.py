...
yolo_model = YOLO('epoch115.pt')  # Asegúrate de tener el modelo yolov8 (puede ser 'yolov8n.pt', 'yolov8s.pt', etc.)
...
def decir_mensaje(mensaje):
    ...
    mensaje_archivo = "mensaje.mp3"
    tts.save(mensaje_archivo)  # Guarda el mensaje como un archivo .mp3
    playsound(mensaje_archivo)  # Reproduce el archivo .mp3
